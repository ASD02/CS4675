export const PostsData = [
    ...
    },
    {
        img: NaN,
        name: 'Maryam',
        desc: "Councilman David James said the memorial WILL come down. Please let him know how you feel about this. WDRB Reported:CLEANSING OUR PAST WILL NOT CHANGE IT! WE CAN ONLY LEARN FROM IT! Per Councilman James: The statues will come off this morning. The rest of the monument will be disassembled later.",
        likes: 64,
        liked: false
    ...
    },
    {
        img:NaN,
        name: "CNN",
        desc: "Green Party candidate Jill Stein late Saturday vowed to bring her fight for a recount of votes cast in Pennsylvania in the U.S. presidential election to federal court, after a state judge ordered her campaign to post a $1 million bond. \"The Stein campaign will continue to fight for a statewide recount in Pennsylvania\", Jonathan Abady, lead counsel to Stein's recount efforts, said in a statement.",
        likes: 62,
        liked: false
    },
    {
        img:NaN,
        name: "News11 Kansas",
        desc: "Kansas Governor Sam Brownback on Thursday signed into law a school funding bill that will face scrutiny by the state supreme court to determine if it fulfills a mandate for adequacy. The Republican governor said he approved the measure even though the legislature missed an opportunity to substantially improve the K-12 funding system.",
        likes: 23,
        liked: true
    },
    {
    ...
    },
    {
        img:NaN,
        name: "RyanOut",
        desc: "1.5 TRILLION Net Wealth Lost In 15 Days!It s never about America, when it comes to this fraud.  It s not about telling the truth about our economy or about the accepting responsibility for 93.8 million unemployed Americans. It s only about this egomaniac and his false legacy",
        likes: 97,
        liked: true
    },
    {
    ...
    },
    {
        img:NaN,
        name: "Reuters",
        desc: "President-elect Donald Trump on Thursday named U.S. Representative Ryan Zinke of Montana, a former Navy SEAL commander who questions whether humans are largely the cause of climate change, as his choice for secretary of the interior. If the Senate confirms Zinke, a Republican, to lead the Interior Department, he will head an agency that employs more than 70,000 people across the country and oversees more than 20 percent of federal land, including national parks such as Yellowstone and Yosemite. As a one-term U.S. congressman, Zinke took several stances favoring coal, which is high in carbon emissions when burned. Coal output suffered during the administration of Democratic President Barack Obama as the development of competing fuels natural gas and solar and wind power soared.",
        likes: 478,
        liked: true
    }
]